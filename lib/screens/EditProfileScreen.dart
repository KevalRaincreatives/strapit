...
class EditProfileScreen extends StatefulWidget {
  ...
  String? CustomerId,name,email,phone,country,password;
   EditProfileScreen({this.CustomerId,this.name,this.email,this.phone,this.country,this.password});
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<String?> fetchadd() async {
    try {
      ...
      countryCont.text = widget.country!;
      return '';
    } catch (e) {
...
//        print("cat dta$cat_model");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        title: Text("Edit Profile",style: TextStyle(color: sh_app_txt_color,fontSize: 24,fontFamily: 'Bold'),),
        backgroundColor: sh_white,
