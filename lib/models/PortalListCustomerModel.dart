...
///
class PortalListCustomerModelData {
/*
{
  "id": 1,
  "name": "Moco",
...
*/
  ...
  PortalListCustomerModelData.fromJson(Map<String, dynamic> json) {
    id = json['id']?.toInt();
...
*/
  ...
  bool? success;
  List<PortalListCustomerModelData?>? data;
  String? message;
  ...
  PortalListCustomerModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    if (json['data'] != null) {
      final v = json['data'];
      final arr0 = <PortalListCustomerModelData>[];
      v.forEach((v) {
        arr0.add(PortalListCustomerModelData.fromJson(v));
      });
      this.data = arr0;
    }
